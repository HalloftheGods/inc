<?php
/*
* This template overwrites original template-part-small-banner.php in Sterling Theme.
* use diff tool to compare and see the difference in code modification.
*/
...
<!--modification in this line --> <p class="page-banner-heading"><?php st_bp_post_title(); ?></p>
        ...
        <?php if ( 'true' == $breadcrumbs ) : ?>
<!--modification in this line --> <div class="breadcrumbs"><?php st_bp_breadcrumbs(); ?></div><!-- end .breadcrumbs -->
        <?php endif; ?>
    </div><!-- end .center-wrap -->
    <div class="shadow top"></div>
    <div class="shadow bottom"></div>
