...
$jacket_slider = upfront_create_region(
			array (
  'name' => 'jacket-slider',
  'title' => 'Jacket Slider',
  'type' => 'wide',
  'scope' => 'local',
  'container' => 'jacket-slider',
  'position' => 1,
  'allow_sidebar' => true,
),
			array (
...
$regions->add($jacket_slider);

$jacket_content = upfront_create_region(
			array (
  'name' => 'jacket-content',
  'title' => 'Jacket Content',
  'type' => 'wide',
  'scope' => 'local',
  'container' => 'jacket-content',
  'position' => 1,
  'allow_sidebar' => true,
),
			array (
  ...
  'background_image' => '{{upfront:style_url}}/images/single-page-jacket/noise.jpg',
...
$jacket_content->add_element("Uspacer", array (
  'columns' => '2',
  'margin_left' => '0',
  'margin_right' => '0',
  'margin_top' => '0',
...
$jacket_content->add_element("PlainTxt", array (
  'columns' => '20',
  'margin_left' => '0',
  'margin_right' => '0',
  'margin_top' => '0',
...
<h1 style="text-align: center;">Jacket</h1>
</div>',
    'type' => 'PlainTxtModel',
