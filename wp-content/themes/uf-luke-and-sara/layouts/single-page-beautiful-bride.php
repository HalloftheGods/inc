...
$bb_slider = upfront_create_region(
			array (
  'name' => 'bb-slider',
  'title' => 'BB Slider',
  'type' => 'wide',
...
$regions->add($bb_slider);

$bb_content = upfront_create_region(
			array (
  'name' => 'bb-content',
  'title' => 'BB Content',
  'type' => 'wide',
  'scope' => 'local',
  'container' => 'bb-content',
  'position' => 1,
  'allow_sidebar' => true,
),
			array (
  ...
  'background_image' => '{{upfront:style_url}}/images/single-page-beautiful-bride/noise.jpg',
...
$bb_content->add_element("Uspacer", array (
  'columns' => '2',
  'margin_left' => '0',
  'margin_right' => '0',
  'margin_top' => '0',
...
$bb_content->add_element("PlainTxt", array (
  'columns' => '20',
  'margin_left' => '0',
  'margin_right' => '0',
  'margin_top' => '0',
  ...
  array (
    ...
    'id_slug' => 'plain_text',
    'usingNewAppearance' => true,
    'content' => '<h1 style="text-align: center;">Beautiful Bride</h1>',
    'type' => 'PlainTxtModel',
...
$bb_content->add_element("PlainTxt", array (
  ...
  array (
    ...
    'id_slug' => 'plain_text',
    'usingNewAppearance' => true,
    'content' => '<h6 class="" style="text-align: center;">ANUT WISI ENIM AD MINIM VENIAM, QUIS NOSTRUD EXERCITATION ULLAMCORPER SUSCIPIT LOBORTIS NISL UT ALIQUIP EX EA COMMODO CONSEQUAT. DUIS AUTEM VEL EUM IRIURE DOLOR IN HENDRERIT IN VULPUTATE VELIT ESSE MOLESTIE CONSEQUAT.</h6>',
    'type' => 'PlainTxtModel',
