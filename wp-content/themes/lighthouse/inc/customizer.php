...
function lighthouse_customize_register( $wp_customize ) {
 ...
 $wp_customize->remove_control('display_header_text');
	...
	$wp_customize->add_section(
		'lighthouse_rating',
		array(
			'title' => __('Rate Lighthouse <3', 'lighthouse'),
			'priority' => 999,
			'description' => __('We work hard & do our best to give you an awesome theme. If you like Lighthouse then let the developer know, he gets so happy!', 'lighthouse') . '<br> <br><a class="button button-primary" href="https://wordpress.org/support/theme/lighthouse/reviews/?filter=5" target="_blank">Click here to rate Lighthouse</a> ',
			)
		);  
	$wp_customize->add_setting('lighthouse_rating[info]', array(
		'sanitize_callback' => 'lighthouse_no_sanitize',
		'type' => 'info_control',
		'capability' => 'edit_theme_options',
		)
	);
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'rating_section', array(
		'section' => 'lighthouse_rating',
		'settings' => 'lighthouse_rating[info]',
		'type' => 'textarea',
		'priority' => 105
		) )
	);   
