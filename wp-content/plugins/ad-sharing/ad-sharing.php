...
class Ad_Sharing {
	...
	function plug_network_pages() {
		add_submenu_page( 'settings.php', __( 'Advertising', 'ad_sharing' ), __( 'Advertising', 'ad_sharing' ), 'manage_network_options', 'admin-advertising', array(
			&$this,
			'admin_output'
		) );
	}
	...
	function plug_pages() {
		...
		if ( version_compare( $wp_version, '3.0.9', '>' ) ) {
			add_submenu_page( 'ms-admin.php', __( 'Advertising', 'ad_sharing' ), __( 'Advertising', 'ad_sharing' ), 'manage_network_options', 'admin-advertising', array(
				&$this,
				'admin_output'
			) );
		}
		add_submenu_page( 'options-general.php', __( 'Advertising', 'ad_sharing' ), __( 'Advertising', 'ad_sharing' ), 'manage_options', 'user-advertising', array(
			&$this,
			'user_output'
		) );
	}
	...
	function plug_singlesite_pages() {
		add_submenu_page( 'options-general.php', __( 'Advertising', 'ad_sharing' ), __( 'Advertising', 'ad_sharing' ), 'manage_options', 'admin-advertising', array(
			&$this,
			'admin_output'
		) );
		if ( ! current_user_can( 'edit_others_posts' ) ) {
			add_submenu_page( 'profile.php', __( 'Advertising', 'ad_sharing' ), __( 'Advertising', 'ad_sharing' ), 'edit_posts', 'user-advertising', array(
				&$this,
				'user_output'
			) );
		}
			...
			<form method="post" action="?page=admin-advertising&action=process">
				...
				<table class="form-table">
					<tr valign="top">
						...
						<td>
							...
							<select name="advertising_share" id="advertising_share">
								<option
									value="75"<?php selected( $advertising_share, '75' ) ?>><?php _e( 'Site 25% / User 75%', 'ad_sharing' ); ?></option>
								<option
									value="50"<?php selected( $advertising_share, '50' ) ?>><?php _e( 'Site 50% / User 50%', 'ad_sharing' ); ?></option>
								<option
									value="25"<?php selected( $advertising_share, '25' ) ?>><?php _e( 'Site 75% / User 25%', 'ad_sharing' ); ?></option>
							</select>
					...
					<tr valign="top">
						...
						<td>
							<label for="advertising_filter_ads">
								<input name="advertising_filter_ads" id="advertising_filter_ads" value="1"
								       type="checkbox"<?php checked( get_site_option( 'advertising_filter_ads' ), '1' ) ?>>
					...
					<tr valign="top">
						...
						<td>
							<label for="advertising_location_before_post_content">
								<input name="advertising_location_before_post_content"
								       id="advertising_location_before_post_content" value="1"
								       type="checkbox"<?php checked( get_site_option( 'advertising_location_before_post_content' ), '1' ) ?>>
								<?php _e( 'Before Post Content', 'ad_sharing' ); ?>
							</label>
							<br/>
							<label for="advertising_location_after_post_content">
								<input name="advertising_location_after_post_content"
								       id="advertising_location_after_post_content" value="1"
								       type="checkbox"<?php checked( get_site_option( 'advertising_location_after_post_content' ), '1' ) ?>>
								<?php _e( 'After Post Content', 'ad_sharing' ); ?>
							</label>
							<br/>
							<label for="advertising_location_before_page_content">
								<input name="advertising_location_before_page_content"
								       id="advertising_location_before_page_content" value="1"
								       type="checkbox"<?php checked( get_site_option( 'advertising_location_before_page_content' ), '1' ) ?>>
								<?php _e( 'Before Page Content', 'ad_sharing' ); ?>
							</label>
							<br/>
							<label for="advertising_location_after_page_content">
								<input name="advertising_location_after_page_content"
								       id="advertising_location_after_page_content" value="1"
								       type="checkbox"<?php checked( get_site_option( 'advertising_location_after_page_content' ), '1' ) ?>>
					...
					<tr valign="top">
						...
						<td>
							<textarea name="advertising_before_code" type="text" rows="5" wrap="soft"
							          id="advertising_before_code"
							          style="width: 95%"/><?php echo esc_textarea( $advertising_before_code ); ?></textarea>
					...
					<tr valign="top">
						...
						<td>
							<textarea name="advertising_after_code" type="text" rows="5" wrap="soft"
							          id="advertising_after_code"
							          style="width: 95%"/><?php echo esc_textarea( $advertising_after_code ); ?></textarea>
					...
					<tr valign="top">
						...
						<td>
							<textarea name="advertising_message" type="text" rows="5" wrap="soft"
							          id="advertising_message"
							          style="width: 95%"/><?php echo esc_textarea( $advertising_message ); ?></textarea>
						...
						<tr valign="top">
							...
							<td>
								...
								<select name="advertising_main_blog" id="advertising_main_blog">
									<option
										value="hide"<?php selected( $advertising_main_blog, 'hide' ) ?>><?php _e( 'Hide Ads', 'ad_sharing' ); ?></option>
									<option
										value="show"<?php selected( $advertising_main_blog, 'show' ) ?>><?php _e( 'Show Ads', 'ad_sharing' ); ?></option>
								</select>
							</td>
						</tr>
					<?php } ?>
					...
					if ( get_site_option( 'advertising_location_before_post_content' ) == '1' || get_site_option( 'advertising_location_before_page_content' ) == '1' ) {
						...
						<tr valign="top">
							...
							<td>
								<textarea name="advertising_before_code" type="text" rows="5" wrap="soft"
								          id="advertising_before_code"
								          style="width: 95%"/><?php echo esc_textarea( $this->get_option( 'advertising_before_code', false, $user_id ) ) ?></textarea>
								<br/><?php _e( 'Used before post and page content.', 'ad_sharing' ) ?>
							</td>
						</tr>
						<?php
					...
					if ( get_site_option( 'advertising_location_after_post_content' ) == '1' || get_site_option( 'advertising_location_after_page_content' ) == '1' ) {
						...
						<tr valign="top">
							...
							<td>
								<textarea name="advertising_after_code" type="text" rows="5" wrap="soft"
								          id="advertising_after_code"
								          style="width: 95%"/><?php echo esc_textarea( $this->get_option( 'advertising_after_code', false, $user_id ) ) ?></textarea>
								<br/><?php _e( 'Used after post and page content.', 'ad_sharing' ) ?>
							</td>
						</tr>
						<?php
