...
class XLWUEV_XL_Support {
	...
	public function __construct() {
		...
		add_filter(
			'xl_uninstall_reason_threshold_' . XLWUEV_PLUGIN_BASENAME, function () {
			return 6;
		}
		);
	...
	public function modify_api_args_if_xlwuev_dashboard() {
		if ( XL_dashboard::get_expected_slug() == $this->slug ) {
			...
			XL_dashboard::register_dashboard(
				array(
	...
	public function xlwuev_try_push_notification_for_optin() {
		...
		if ( ! XL_admin_notifications::has_notification( 'xl_optin_notice' ) ) {
			XL_admin_notifications::add_notification(
				array(
					'xl_optin_notice' => array(
                        ...
                        <p><a href=\'%s\' class=\'button button-primary\'>Yes, I want to help</a> <a href=\'%s\' class=\'button button-secondary\'>No, I don\'t want to help</a> <a style="float: right;" target="_blank" href=\'%s\'>Know More</a></p> ',
							esc_url(
								wp_nonce_url(
									add_query_arg(
										array(
							...
							esc_url( wp_nonce_url( add_query_arg( 'xl-optin-choice', 'no' ), 'xl_optin_nonce', '_xl_optin_nonce' ) ),
							esc_url( 'https://xlplugins.com/data-collection-policy/?utm_source=wpplugin&utm_campaign=wooverify&utm_medium=text&utm_term=optin' )
						),
					),
				)
			);
	...
	public function modify_uninstall_reason( $reasons ) {
		...
		$reasons_our[ XLWUEV_PLUGIN_BASENAME ] = array(
			array(
				'id'                => 27,
				'text'              => __( 'Customers are not receiving the Verification Emails', 'wc-email-confirmation' ),
				'input_type'        => '',
				'input_placeholder' => __( 'Customers are not receiving the Verification Emails', 'wc-email-confirmation' ),
			),
			array(
				'id'                => 36,
				'text'              => __( 'Verification Email is delayed for few minutes', 'wc-email-confirmation' ),
				'input_type'        => '',
				'input_placeholder' => __( 'Verification Email is delayed for few minutes', 'wc-email-confirmation' ),
			),
			array(
				'id'                => 37,
				'text'              => __( 'User doesn\'t get verified after clicking on verification link', 'wc-email-confirmation' ),
				'input_type'        => '',
				'input_placeholder' => __( 'User doesn\'t get verified after clicking on verification link', 'wc-email-confirmation' ),
			),
			array(
				'id'                => 38,
				'text'              => __( 'User is not able to login after verification', 'wc-email-confirmation' ),
				'input_type'        => '',
				'input_placeholder' => __( 'User is not able to login after verification', 'wc-email-confirmation' ),
			),
			array(
				'id'                => 3,
				'text'              => __( 'I only needed the plugin for a short period', 'wc-email-confirmation' ),
				'input_type'        => '',
				'input_placeholder' => __( 'I only needed the plugin for a short period', 'wc-email-confirmation' ),
			),
			array(
				'id'                => 39,
				'text'              => __( 'The plugin broke my site, or results in White blank screen', 'wc-email-confirmation' ),
				'input_type'        => '',
				'input_placeholder' => __( 'The plugin broke my site, or results in White blank screen', 'wc-email-confirmation' ),
			),
			array(
				'id'                => 40,
				'text'              => __( 'The plugin suddenly stopped working after Update', 'wc-email-confirmation' ),
				'input_type'        => '',
				'input_placeholder' => __( 'The plugin suddenly stopped working after Update', 'wc-email-confirmation' ),
			),
			array(
				'id'                => 35,
				'text'              => __( 'Doing Testing', 'wc-email-confirmation' ),
				'input_type'        => '',
				'input_placeholder' => __( 'Doing Testing', 'wc-email-confirmation' ),
			),
		);
