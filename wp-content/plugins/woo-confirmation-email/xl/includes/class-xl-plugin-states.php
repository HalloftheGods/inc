...
if (!class_exists('PW_Plugin_states')) :
    ...
    class PW_Plugin_states {
        ...
        /**
         * Funciton to detect if the given module is currently active or not
         * We use wordpress core funtion `is_plugin_active` to wrap it over
        ...
        /**
         * Checking the license data and if we have appropiate error message the declear3ed this plugin as invalid license
         * @return type
         */
