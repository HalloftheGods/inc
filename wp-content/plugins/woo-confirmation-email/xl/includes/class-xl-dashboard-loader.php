...
/**
 * This class is a mail loader class for dashboard page , controlls and sets up all the necessery actions
 *
 * @author XLPlugins
 * @package XLCore
 */
class XL_dashboard {
	 ...
	 * Set the required variables and register some importnat hooks
	 */
	public static function init() {
		...
		/**
		 * Function to trigger errormessage at WordPress plugins page when we have update but license invalid
		 */
	...
	public static function xl_licenses_data() {
		...
		return (object) array_merge(
			(array) $get_list, (array) array(
			'additional_tabs' => apply_filters( 'xl_additional_tabs', array( array( 'slug' => 'tools', 'label' => __( 'Tools', 'xlplugins' ) ) ) ),
...
//Intialilize the instance so that some necceserry hooks can run on each load
