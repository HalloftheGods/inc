 ...
 *
 * Woocommerce Email Verification is free software.
 * You can redistribute it and/or modify it under the terms of the GNU General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * any later version.
 *
 * Woocommerce Email Verification is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
 * GNU General Public License for more details.
 *
 * You should have received a copy of the GNU General Public License
 * along with Woocommerce Email Verification. If not, see <http://www.gnu.org/licenses/>.
 */
if ( ! defined( 'ABSPATH' ) ) {
...
if ( ! class_exists( 'XLWUEV_Core' ) ) :
	class XLWUEV_Core {
		...
		public function define_plugin_properties() {
			/*             * ****** DEFINING CONSTANTS ********* */
			define( 'XLWUEV_SLUG', 'wc-email-confirmation' );
			define( 'XLWUEV_VERSION', '3.1.11' );
			define( 'XLWUEV_DIR', __DIR__ );
			define( 'XLWUEV_MIN_WC_VERSION', '2.6' );
			define( 'XLWUEV_TEXTDOMAIN', 'wc-email-confirmation' );
		...
		public function include_commons() {
			...
			require 'includes/class-xlwuev-upsell.php';
		}
		...
		public function xlwuev_wc_not_installed_notice() {
            ...
            <div class="error">
                <p>
					<?php
					echo __( 'WooCommerce is not installed or activated. Woocommerce User Email Verification is a WooCommerce Extension and would only work if WooCommerce is activated. Please install the WooCommerce Plugin first.', 'wc-email-confirmation' );
					?>
                </p>
            </div>
			<?php
