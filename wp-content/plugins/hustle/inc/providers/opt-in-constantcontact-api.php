            ...
            */
            function process_callback_request() {
                if ( $this->validate_callback_request( 'constantcontact' ) ) {
                    ...
                    $authorization_uri = $this->get_authorization_uri(false, false);
             ...
             * @return string
             */
            function get_authorization_uri( $optin_id = 0, $log_referrer = true ) {
                ...
                if ( $log_referrer ) {
                    ...
                    */
                    $referer = add_query_arg( array( 'page'  => 'inc_optin',
                                                     'optin' => $optin_id
                                            ), admin_url( 'admin.php' ) );
