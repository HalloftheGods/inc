<?php
// This is (for convenience) just a clone of the file views/phpbb_last_topics.php
// This file views/phpbb_last_topics_output_shortcode.php output Last Topics shortcode
// While the views/phpbb_last_topics.php output on widgets
