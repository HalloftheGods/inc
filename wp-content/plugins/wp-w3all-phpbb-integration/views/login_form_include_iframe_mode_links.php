...
if ( is_user_logged_in() && isset($phpbb_user_session) ){ 
		...
		echo '<li class="'.$w3all_loginform_style_li_class.'">' . __( 'You have ', 'wp-w3all-phpbb-integration' ) . '<a href="'.$wp_w3all_forum_folder_wp.'/?i=pm&folder=inbox">' . $phpbb_user_session[0]->user_unread_privmsg . '</a>' . __( ' unread forum\'s pm' , 'wp-w3all-phpbb-integration' ) . '</li>';
	  }
