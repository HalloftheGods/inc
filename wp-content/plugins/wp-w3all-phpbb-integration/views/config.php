...
<br />Path example to phpBB root folder, for config.php on phpBB root folder: <i>/web/htdocs/home/<b>forum</b></i>
...
<br />Note about .htaccess: <b>"i\'ve setup avatar here, but avatar\'s images aren\'t displayed!" ... please <a href="https://www.axew3.com/w3/2016/09/phpbb-htaccess-set-avatars-images-available-over-your-domain/" target="_blank">take a look to this <i>why and how to resolve</i> post</a></b> before you activate this feature.
...
<hr />
<div class=""><?php echo __('<h3 style="color:#da5252">Replace Buddypress profile avatar with phpBB user avatar</h3><b>This option affect only if Buddypress is installed into your WordPress.</b> If activated, the Buddypress profile user\'s avatar will be replaced by the phpBB user\'s avatar, where available: if not, the default avatar of the user in WP will be retrieved.<br /><strong>Note</strong>: to have the Buddypress user\'s uploaded avatar shown into phpBB, phpBB need to have <b>"Enable remote avatars"</b> option set to YES in order to this feature to work correctly in<br />phpBB ACP -> Board Configuration -> Avatar settings.<br /><br />Note: affect only if the above <i style="color:#869eff">Use phpBB avatar to replace WordPress user\'s avatar</i> option is set to yes', 'wp-w3all-phpbb-integration'); ?></div>
