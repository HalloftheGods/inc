...
// For compatibility with all the rest, if the case, these vars are switched
if( isset($_GET["f"]) ){
...
// $document_domain = 'mysite.com'; // in case, setup manually here. ex:  mysite.com, or more below
